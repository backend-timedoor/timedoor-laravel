...
```bash
# inside Claude Code
/plugin marketplace add <your-github-username>/timedoor-laravel
...
## How the standards evolve / Cara standar berkembang
...
Contributions welcome via issues and PRs. Semua diskusi boleh dalam Bahasa Indonesia maupun English.

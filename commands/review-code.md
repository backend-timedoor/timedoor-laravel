...
Steps:
1. Read the skill's SKILL.md, then the reference files relevant to the code under review (coding-standards, security, api-response, manual-rules, the matching patterns file, version-notes if version-specific constructs appear).

...
3. `./vendor/bin/pint` on changed PHP files only — fix all style issues without reformatting unrelated files. If Pint is not installed in the project, note it to the user and suggest adding it.
